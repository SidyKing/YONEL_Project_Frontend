...
export class CreerAgenceComponent {
  ...
  ngOnInit(): void {
    this.AgenceForm = this.formBulder.group({
  ...
  onSubmit() {
    ...
    if (this.AgenceForm.invalid) {
      ...
      this.authService.CreerAgence(
        this.AgenceForm.value.code,
  ...
  alertBad(){
    Swal.fire({
      icon: 'error',
      title: 'Erreur...',
      text: 'Echec de la création de l\'agence !',
    })
  }
